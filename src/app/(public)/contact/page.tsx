  ...
  return (
    <div className="bg-background text-body">
      <section className="relative overflow-hidden border-b bg-gradient-to-br from-[#4A1D8F] via-[#7C3AED] to-[#F05A7E] text-white">
        ...
        <div className="absolute -bottom-28 right-0 h-96 w-96 rounded-full bg-secondary/30 blur-3xl" />
        <div className="cw-container relative grid min-h-[660px] gap-10 py-20 md:grid-cols-[1.35fr_0.85fr] md:items-center md:py-28">
          <div>
            <span className="inline-flex rounded-pill border border-white/25 bg-white/15 px-4 py-1.5 text-[10px] font-extrabold uppercase tracking-[0.24em] text-white/85 backdrop-blur">
            ...
            <h1 className="mt-6 max-w-3xl text-5xl font-black leading-[0.96] tracking-tight md:text-7xl">
              Say hello.
              <span className="block text-white/80">We answer in person, fast.</span>
            </h1>
        ...
        <div className="cw-container">
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight text-body md:text-4xl">
      ...
      <section id="contact-form" className="cw-section">
        <div className="cw-container grid gap-10 lg:grid-cols-[1.45fr_0.9fr]">
          <div className="rounded-[28px] border bg-card p-6 shadow-elevated md:p-8">
            <span className="text-xs font-extrabold uppercase tracking-[0.25em] text-primary">
              Write to us
            </span>
            <h2 className="mt-3 text-3xl font-black tracking-tight text-body md:text-4xl">
      ...
      <section id="studio" className="grid bg-card md:grid-cols-2">
        ...
        <div className="relative min-h-[520px] overflow-hidden bg-[#EEF3FF]">
...
function EnvelopeCard({
  ...
  return (
    <div className={`rounded-[28px] border border-white/25 bg-white/92 p-6 text-body shadow-elevated backdrop-blur ${className}`}>
...
function ContactCard({
  ...
  return (
    <a
      href={href}
      className="group rounded-[24px] border bg-card p-6 shadow-soft transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-elevated"
    >
...
function SocialCard({ count, name, handle }: (typeof SOCIALS)[number]) {
  return (
    <a
      href="/contact"
      className="rounded-[24px] border bg-card p-5 shadow-soft transition-all hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-elevated"
    >
